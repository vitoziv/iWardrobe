...
+ (void)setupData
{
    [IWContextManager saveOnBackContext:^(NSManagedObjectContext *backgroundContext) {
        ...
        Item *item1 = [Item createItemWithImage:image1 imageMetaData:nil inContext:backgroundContext];
        item1.name = @"1 New Balance Men's MR10 Minimus Road Running Shoe";
        item1.note = @"1 New Balance, is dedicated to helping athletes achieve their goals. It's been their mission for more than a century. It's why they don't spend money on celebrity endorsements. They spend it on research and development. It's why they don't design products to fit an image. They design them to fit. New Balance is driven to make the finest shoes for the same reason athletes lace them up: to achieve the very best.";
        ...
        Item *item2 = [Item createItemWithImage:image2 imageMetaData:nil inContext:backgroundContext];
        item2.name = @"2 New Balance Men's MR10 Minimus Road Running Shoe";
        item2.note = @"2 New Balance, is dedicated to helping athletes achieve their goals. It's been their mission for more than a century. It's why they don't spend money on celebrity endorsements. They spend it on research and development. It's why they don't design products to fit an image. They design them to fit. New Balance is driven to make the finest shoes for the same reason athletes lace them up: to achieve the very best.";
        ...
        Item *item3 = [Item createItemWithImage:image3 imageMetaData:nil inContext:backgroundContext];
        item3.name = @"3 New Balance Men's MR10 Minimus Road Running Shoe";
        item3.note = @"3 New Balance, is dedicated to helping athletes achieve their goals. It's been their mission for more than a century. It's why they don't spend money on celebrity endorsements. They spend it on research and development. It's why they don't design products to fit an image. They design them to fit. New Balance is driven to make the finest shoes for the same reason athletes lace them up: to achieve the very best.";
